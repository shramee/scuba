							...
							<div class="article">
								...
								<div class="post-info">
									...
									<span class="author-info-inline">
											...
											echo st_get_profile_avatar( $author_id, 25 )
											?>
								...
								<div id="comment-wrapper">
									<h2
										class="title"><?php comments_number( __( 'Comment (0)', ST_TEXTDOMAIN ), __( 'Comment (1)', ST_TEXTDOMAIN ), __( 'Comments (%)', ST_TEXTDOMAIN ) ); ?></h2>
