...
if ( 'pingback' == $comment->comment_type || 'trackback' == $comment->comment_type ) :
	...
	$user         = TravelHelper::get_username( $user_id );
	if ( $user === __( 'Customer', ST_TEXTDOMAIN ) ) {
		$user = __( 'Guest', ST_TEXTDOMAIN );
	}
		...
		<div class="comment-item-head">
			<div class="media">
				...
				<div class="media-body">
					<h4 class="media-heading"><?php echo $user; ?></h4>
		...
		<div class="comment-item-body">
			...
			<?php if ( isset( $post_type ) and in_array( $post_type, [ 'st_tours', 'st_activity' ] ) ) { ?>
				<?php if ( $comment_title = get_comment_meta( $comment_id, 'comment_title', true ) ): ?>
					<h4 class="title st_tours" <?php if ( ! $stats ) {
